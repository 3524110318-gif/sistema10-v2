    ...
    <div class="gtri-page-header">
        ...
        <div>
            ...
            <p class="gtri-page-subtitle">
                ...
                Actualiza los datos de la incidencia seleccionada.
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            >
                                ...
                                <option
                                    value="retardo"
                                    @selected(old('tipo', $incidencia->tipo) === 'retardo')
                                >
                                ...
                                <option
                                    value="permiso"
                                    @selected(old('tipo', $incidencia->tipo) === 'permiso')
                                >
                                ...
                                <option
                                    value="incapacidad"
                                    @selected(old('tipo', $incidencia->tipo) === 'incapacidad')
                                >
